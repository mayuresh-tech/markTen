...
billAmountButton.addEventListener("click", function() {
    if(document.getElementById("input-amount-number").value.trim() === null || document.getElementById("input-amount-number").value.trim() === "" || parseInt(document.getElementById("input-amount-number").value.trim()) === 0 ||  parseInt(document.getElementById("input-amount-number").value.trim()) < 0) {
...
paidAmountButton.addEventListener("click", function() {
    if(parseInt(document.getElementById("input-cash-given").value.trim()) != 0 && parseInt(document.getElementById("input-amount-number").value.trim()) != 0 && parseInt(document.getElementById("input-cash-given").value.trim()) > 0 && parseInt(document.getElementById("input-amount-number").value.trim()) > 0) {
